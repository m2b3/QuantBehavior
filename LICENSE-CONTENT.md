...
Under this license, you may share and adapt the licensed material provided that
you:
...
The full, controlling license terms are available in the
...
> by Suresh Krishna, from
> [QuantBehavior](https://github.com/m2b3/QuantBehavior), licensed under
> [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/).

Please also indicate if you modified the material.
